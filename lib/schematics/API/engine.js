...
/**
 * Runs a fun-cli schematic inside a given root.
 *
 * @param {string}       root      The given root dir
 * @param {string}       name      The name of the fun-cli schematic to be runned
 * @param {any}          [args]    The arguments that should be passed to the schematic
 * @param {{
 *  debug: boolean,
 *  dryRun: boolean,
 *  force: boolean
 * }}                    [options] Schematic engine options
 *
 */
let run = async (
  root,
  ...
  let logger = createLogger('fun-cli');
