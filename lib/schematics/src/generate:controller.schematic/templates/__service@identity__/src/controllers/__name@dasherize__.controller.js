...
const <%= classify(name) %>Repository = require('../repositories/<%= dasherize(name) %>.repository');
...
class <%= classify(name) %>Controller extends BaseController {
   ...
   *
   * @apiSuccess {Array} data An array of <%= plural(camelize(name)) %>
   *
   */
   ...
   *
   * @apiSuccess {Object} data A reference to the created <%= camelize(name) %>
   *
   */
   ...
   *
   * @apiSuccess {Object} data A reference to the updated <%= camelize(name) %>.
   *
   */
